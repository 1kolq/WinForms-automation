...
namespace WindowsFormsApp1 {
    ...
    public partial class databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public usersRow AddusersRow(string Имя, string Фамилия, string Отчество, string Номер_телефона, string Дата_рождения, string Номер_карты, string Бонусы, string Логин, string Пароль) {
        ...
        public partial class usersRow : global::System.Data.DataRow {
            ...
            public string Номер_телефона {
                get {
                    try {
                        return ((string)(this[this.tableusers.Номер_телефонаColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Номер телефона\' в таблице \'users\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableusers.Номер_телефонаColumn] = value;
                }
            }
            ...
            public string Дата_рождения {
                get {
                    try {
                        return ((string)(this[this.tableusers.Дата_рожденияColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public string Номер_карты {
                get {
                    try {
                        return ((string)(this[this.tableusers.Номер_картыColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Номер карты\' в таблице \'users\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableusers.Номер_картыColumn] = value;
                }
            }
            ...
            public string Бонусы {
                get {
                    try {
                        return ((string)(this[this.tableusers.БонусыColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Бонусы\' в таблице \'users\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableusers.БонусыColumn] = value;
                }
            }
            ...
            public bool IsНомер_телефонаNull() {
                return this.IsNull(this.tableusers.Номер_телефонаColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetНомер_телефонаNull() {
                this[this.tableusers.Номер_телефонаColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IsНомер_картыNull() {
                return this.IsNull(this.tableusers.Номер_картыColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetНомер_картыNull() {
                this[this.tableusers.Номер_картыColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public bool IsБонусыNull() {
                return this.IsNull(this.tableusers.БонусыColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetБонусыNull() {
                this[this.tableusers.БонусыColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsApp1.databaseDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `users` WHERE ((`id` = ?) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Номер телефона` IS NULL) OR (`Номер телефона` = ?)) AND ((? = 1 AND `Дата рождения` IS NULL) OR (`Дата рождения` = ?)) AND ((? = 1 AND `Номер карты` IS NULL) OR (`Номер карты` = ?)) AND ((? = 1 AND `Бонусы` IS NULL) OR (`Бонусы` = ?)) AND ((? = 1 AND `Логин` IS NULL) OR (`Логин` = ?)) AND ((? = 1 AND `Пароль` IS NULL) OR (`Пароль` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`Имя`, `Фамилия`, `Отчество`, `Номер телефона`, `Дата рожден" +
                "ия`, `Номер карты`, `Бонусы`, `Логин`, `Пароль`) VALUES (?, ?, ?, ?, ?, ?, ?, ?," +
                " ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `users` SET `Имя` = ?, `Фамилия` = ?, `Отчество` = ?, `Номер телефона` = ?, `Дата рождения` = ?, `Номер карты` = ?, `Бонусы` = ?, `Логин` = ?, `Пароль` = ? WHERE ((`id` = ?) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Номер телефона` IS NULL) OR (`Номер телефона` = ?)) AND ((? = 1 AND `Дата рождения` IS NULL) OR (`Дата рождения` = ?)) AND ((? = 1 AND `Номер карты` IS NULL) OR (`Номер карты` = ?)) AND ((? = 1 AND `Бонусы` IS NULL) OR (`Бонусы` = ?)) AND ((? = 1 AND `Логин` IS NULL) OR (`Логин` = ?)) AND ((? = 1 AND `Пароль` IS NULL) OR (`Пароль` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Имя, Фамилия, Отчество, [Номер телефона], [Дата рождения], [Номер карт" +
                "ы], Бонусы, Логин, Пароль FROM users";
        ...
        public virtual int Delete(int Original_id, string Original_Имя, string Original_Фамилия, string Original_Отчество, string Original_Номер_телефона, string Original_Дата_рождения, string Original_Номер_карты, string Original_Бонусы, string Original_Логин, string Original_Пароль) {
            ...
            if ((Original_Бонусы == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((string)(Original_Бонусы));
            }
        ...
        public virtual int Insert(string Имя, string Фамилия, string Отчество, string Номер_телефона, string Дата_рождения, string Номер_карты, string Бонусы, string Логин, string Пароль) {
            if ((Имя == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Номер_карты, 
                    string Original_Бонусы, 
            ...
            if ((Original_Номер_карты == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_Номер_карты));
            }
            if ((Original_Бонусы == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_Бонусы));
            }
            if ((Original_Логин == null)) {
